...
serverAddressPort   = ("10.0.0.2", 18007)
bufferSize          = 2808
...
clientAddressPort   = ("10.0.0.1", 18005)
...
while i<65536*2:
    ...
    bytesToSend = b'\1'*152  # it needs to be 71 bytes for the coordinate_data and fsr_data to be seen on the udp_server. DO NOT CHANGE THIS NUMBER
    # try:
    temp=UDPClientSocket.sendto(bytesToSend, socket.MSG_DONTWAIT, serverAddressPort)
    # print(type(temp))
    # print("Received message: {}".format(bytesToSend.decode()))
